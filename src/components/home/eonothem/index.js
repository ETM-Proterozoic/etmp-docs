...
export default function Eonothem(){
  return (
    <div className="eonothem-view">
      ...
      <p className="eonothem-view-desc">Eonothem (ETM) is the totality of data and information laid down in the record deposited during a certain eon of the continuous metaverse timescale. This Eonothem is unchangeable, retrievable, and verifiable. The development timeline of Eonothem blockchain will be in 4 stages: Hadean, Archean, Proterozoic, and Phanerozoic.
